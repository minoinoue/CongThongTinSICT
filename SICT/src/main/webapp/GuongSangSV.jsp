...
<head>
    ...
    <style>
        ...
        .student-item .content h3 {
            font-size: 1.5em;
            margin: 0 0 10px;
        }
        .student-item .content h3 a {
            color: #003087;
            text-decoration: none;
        }
        .student-item .content h3 a:hover {
            text-decoration: underline;
        }
        .student-item .content .date {
            color: #666;
            font-size: 0.9em;
            margin-bottom: 10px;
        }
        .student-item .content .summary {
            color: #333;
            line-height: 1.6;
        }
        .container {
    ...
    <div class="container my-4">
                    ...
                    <div class="student-detail">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Gương sáng sinh viên</li>
                            </ol>
                        </nav>
        ...
        <%
            ...
            try (Connection conn = DatabaseConnection.getConnection()) {
                String sql = "SELECT MaGuongSang, TenSinhVien, MoTaNgan, NgayCapNhat, UrlAnh FROM GuongSangSV ORDER BY NgayCapNhat DESC";
        ...
        <div class="row mb-4 p-3 bg-light rounded shadow-sm">
            ...
            <div class="col-md-4">
                <img src="<%= urlAnh %>" alt="Ảnh sinh viên" class="img-fluid rounded">
            </div>
            <% } %>
            <div class="col-md-8 d-flex flex-column justify-content-between">
                <div>
                    <h5 class="fw-bold" style="color: #003399;">
                        <a href="XemGuongSangSV.jsp?maguongsang=<%= maGuongSang %>" style="text-decoration: none; color: inherit;">
                            <%= tenSinhVien %>
                        </a>
                    </h5>
                ...
                <div>
                    <a href="XemGuongSangSV.jsp?maguongsang=<%= maGuongSang %>" class="fw-bold text-primary">Xem thêm</a>
                </div>
            </div>
        </div>
        <%
